...
class CircleAvatarBuilder extends _CircleAvatarBuilder {
  ...
  CircleAvatar buildCustom({
    ...
    final backgroundImageDecoded = _decodeBackgroundImage(
      value: model.backgroundImage,
    );
    final foregroundImageDecoded = _decodeForegroundImage(
      value: model.foregroundImage,
    );

    return CircleAvatar(
      backgroundColor: model.backgroundColor,
      backgroundImage: backgroundImageDecoded,
      foregroundColor: model.foregroundColor,
      foregroundImage: foregroundImageDecoded,
      key: key,
...
class CircleAvatarSchema {
  static const id =
      'https://peiffer-innovations.github.io/flutter_json_schemas/schemas/gen_build/circle_avatar.json';
